...
- [[resources/Your Code Has Bugs. Lean4 Has Proofs - Formal Verification for Engineers|Your Code Has Bugs. Lean4 Has Proofs: Formal Verification for Engineers — Varun Pant, AWS]]
- [[resources/Productionizing LLM Gateways - Architecture, Tradeoffs and Hard Lessons|Productionizing LLM Gateways: Architecture, Tradeoffs and Hard Lessons — Kanish Manuja, Twilio]]
- [[resources/How to Get Your Org to Adopt Coding Agents (Without Shipping Garbage)|How to Get Your Org to Adopt Coding Agents (Without Shipping Garbage) — Eyal Blum, Figma]]
- [[resources/How to avoid disaster when vibe-coding a billing engine|How to avoid disaster when vibe-coding a billing engine — Andrew Garvin, Stripe]]
- [[resources/How do you diffuse AI into the real world|How do you diffuse AI into the real world? — Varun Shenoy, Long Lake]]
- [[resources/From AI-Assisted to AI-Native - Building a Frontier Development Team|From AI-Assisted to AI-Native: Building a Frontier Development Team — Clare Liguori, AWS]]
- [[resources/Building uReview, Uber’s Multi-Agent Code Review Engine|Building uReview, Uber’s Multi-Agent Code Review Engine — Will Bond & Ameya Ketkar, Uber]]
- [[resources/Building the Engine While Flying the Plane - Launching the Figma MCP Server|Building the Engine While Flying the Plane: Launching the Figma MCP Server — Jesse Lumarie, Figma]]
- [[resources/AI-Native Organisations Run on Skills - How to Structure and Scale Them|AI-Native Organisations Run on Skills: How to Structure and Scale Them — Imad Touil, QuantumBlack]]
- [[resources/AI Evals for Cross-Functional Teams|AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash]]
- [[resources/The Agentic Commerce Stack|The Agentic Commerce Stack — Ahnaf Prio, Best Buy]]
- [[resources/Rethinking Legacy Data Infrastructure|Rethinking Legacy Data Infrastructure with Eon Co-Founders Ofir Ehrlich and Gonen Stein]]
- [[resources/KV Cache-Aware Routing and P - D Disaggregation on Kubernetes|KV Cache-Aware Routing and P/D Disaggregation on Kubernetes — Yuchen Fama & Ashish Kamra, Red Hat]]
- [[resources/How to Generate Mergeable Code|How to Generate Mergeable Code with a Context Engine — Peter Werry, Unblocked]]
- [[resources/How Anthropic Builds - Lessons from Labs|How Anthropic Builds: Lessons from Labs — Mike Krieger, Anthropic]]
- [[resources/Can LLMs Write Fast Multi-GPU Kernels|Can LLMs Write Fast Multi-GPU Kernels? — Simran Arora, Together AI]]
- [[resources/AI Could Take Over in 2029. Is It Already Too Late - - Ryan Greenblatt|AI Could Take Over in 2029. Is It Already Too Late? | Ryan Greenblatt]]
- [[resources/🔬“We have foundation models for language, not for physics”|🔬“We have foundation models for language, not for physics” — Anima Anandkumar, Bren Professor of Computing]]
- [[resources/The Missing Layer in Agentic AI|The Missing Layer in Agentic AI — Giedrius Šteimantas, Oxylabs]]
- [[resources/The Death of Developer Advocates|The Death of Developer Advocates — Stephanie Jarmak, Sourcegraph]]
- [[resources/The Building Blocks of GTM Orchestration|The Building Blocks of GTM Orchestration — Arman Vaziri, Ramp]]
- [[resources/Reverse-Engineering the AI Buyer|Reverse-Engineering the AI Buyer — Aliisa Rosenthal, Acrew Capital]]
- [[resources/Knowledge Systems - The New GTM Stack|Knowledge Systems: The New GTM Stack — Jeffrey Wang, Exa]]
- [[resources/How We Got LLMs to Recommend Our Open Source Library|How We Got LLMs to Recommend Our Open Source Library — Christopher Burns, Inth]]
- [[resources/How AI Agents Let GTM Teams Scale|How AI Agents Let GTM Teams Scale — Justin Joyce, Cloudflare]]
- [[resources/GTM Engineering - The Technical Bits|GTM Engineering: The Technical Bits — Everett Berry, Clay]]
- [[resources/Building GTM AI Agents - Lessons from Deploying to 6,000 Users|Building GTM AI Agents: Lessons from Deploying to 6,000 Users — Sait Izmit, Snowflake]]
- [[resources/AI in GTM at Notion|AI in GTM at Notion — Flora Liu]]
- [[resources/A $10B Hedge Fund’s AI Playbook (Best of the Pod)|A $10B Hedge Fund’s AI Playbook (Best of the Pod)]]
- [[resources/#501|#501 – DHH: Future of Programming, AI, Agentic Engineering, Vibe Coding & Linux]]
- [[resources/Parallel’s Parag Agrawal - Building a New Web for AI Agents|Parallel’s Parag Agrawal: Building a New Web for AI Agents]]
- [[resources/Einstein Arena - Harnessing Collective Agent Intelligence for Open Science|Einstein Arena: Harnessing Collective Agent Intelligence for Open Science — James Zou, Together AI]]
- [[resources/How to close $100K+ enterprise deals, step by step - Jen Abel|How to close $100K+ enterprise deals, step by step | Jen Abel]]
- [[resources/What If Your Chip Design Team Moved Like a Single Body|What If Your Chip Design Team Moved Like a Single Body? — Abduallah Mohamed, AIDAChip]]
- [[resources/The Agent Behind the Curtain - Building the Oz Cloud Agent Platform|The Agent Behind the Curtain: Building the Oz Cloud Agent Platform — Safia Abdalla, Warp]]
- [[resources/Preferences Over Benchmarks - Model Routing|Preferences Over Benchmarks: Model Routing — Archana Kamath & Tyler Gillam, DigitalOcean]]
- [[resources/Inside 847 Production Clinical AI Notes|Inside 847 Production Clinical AI Notes — Sebastian Fox, Composo]]
- [[resources/Give the Agent a Budget, Not a Token|Give the Agent a Budget, Not a Token — Sachin Malhotra, Anthropic]]
- [[resources/FinOps for AI Agents - Who Spent All the Tokens|FinOps for AI Agents: Who Spent All the Tokens? — Tisha Chawla & Susheem Koul, Microsoft]]
- [[resources/Coding Agents Don't Scale Themselves. Neither Do Your Teams|Coding Agents Don't Scale Themselves. Neither Do Your Teams. — Patrick Debois, Tessl]]
- [[resources/Agent Frameworks Considered Harmful|Agent Frameworks Considered Harmful — Rémi Louf, .txt]]
- [[resources/The Missing Layer - Design Taste in AI Agents|The Missing Layer: Design Taste in AI Agents — Hassan El Mghari, Together AI]]
- [[resources/Simulation - the new Scaling Law|Simulation: the new Scaling Law — Joon Sung Park, Simile AI]]
- [[resources/Building Agents Is Trivial Now, Context Is the Next Frontier|Building Agents Is Trivial Now, Context Is the Next Frontier — Jeff Ng, Unblocked]]
- [[resources/Agentic SDLC at Uber|Agentic SDLC at Uber — Uday Kiran Medisetty & Adam Huda, Uber]]
